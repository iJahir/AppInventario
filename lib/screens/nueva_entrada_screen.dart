...
class _NuevaEntradaScreenState extends State<NuevaEntradaScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final providersItems = inventoryProvider.suppliers.map((s) => {
      'id': s['id'].toString(),
  ...
  Widget _buildSectionTitle(BuildContext context, String title) {
    return Text(
      title,
      style: const TextStyle(color: AppColors.moradoPrincipal, fontSize: 13, fontWeight: FontWeight.bold, letterSpacing: 1),
    );
  }
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const Icon(Icons.calendar_today_rounded, color: AppColors.moradoPrincipal, size: 18),
            ],
          ),
        ),
      ],
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          boxShadow: [BoxShadow(color: AppColors.moradoPrincipal.withValues(alpha: 0.2), blurRadius: 10)],
        ),
        child: const Center(
          child: Row(
  ...
  Widget _buildEmptyProducts(BuildContext context) {
    return Center(
      child: Padding(
        ...
        child: Column(
          children: [
            Icon(Icons.inventory_2_outlined, color: AppColors.getSubtextColor(context).withValues(alpha: 0.3), size: 60),
            const SizedBox(height: 10),
            Text('No hay productos agregados', style: TextStyle(color: AppColors.getSubtextColor(context), fontSize: 14)),
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(10),
            decoration: BoxDecoration(color: AppColors.moradoPrincipal.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)),
            child: const Icon(Icons.shopping_bag_outlined, color: AppColors.moradoPrincipal),
          ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: TextStyle(color: isTotal ? AppColors.moradoPrincipal : AppColors.getTextColor(context), fontSize: isTotal ? 20 : 14, fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
          ...
          child: GestureDetector(
            onTap: inventoryProvider.isLoading
                ...
                : () async {
                    ...
                    final success = await inventoryProvider.createTransaction(
                      ...
                      supplierId: _selectedProviderId!,
            ...
            child: Container(
              ...
              child: Center(
                ...
                : const Text('Guardar entrada', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))
              ),
            ),
          ),
        ),
...
class _AgregarProductoModalState extends State<_AgregarProductoModal> {
